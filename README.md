...
void validateDate() {
    ...
    if (mm == 2) {
        if ((isLeap && dd <= 29 && dd >= 1) || (!isLeap && dd <= 28 && dd >= 1))
...
```
# Output:
<img width="418" height="205" alt="image" src="https://github.com/user-attachments/assets/a8e2ad9b-81d4-4170-997f-aaf41b2a07a5" />
...
```
# Output:
<img width="409" height="210" alt="image" src="https://github.com/user-attachments/assets/e2d1ad9d-0118-47a2-b147-f54add22a163" />
...
```
# Output:
<img width="462" height="206" alt="image" src="https://github.com/user-attachments/assets/007f2751-e065-4a2f-97c2-2074eeb8c7c2" />
...
```
# Output:
<img width="515" height="162" alt="image" src="https://github.com/user-attachments/assets/2b1791a8-18a9-4184-afdb-db7219fdb30c" />
...
```
# Output:
<img width="694" height="201" alt="image" src="https://github.com/user-attachments/assets/f15017b0-b120-41f6-9357-712ed61e8ca4" />
